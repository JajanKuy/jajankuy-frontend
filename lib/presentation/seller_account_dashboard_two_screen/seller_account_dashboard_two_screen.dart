import '../seller_account_dashboard_two_screen/widgets/chatcomponent_item_widget.dart';
...
class SellerAccountDashboardTwoScreen extends StatelessWidget {
  SellerAccountDashboardTwoScreen({Key? key}) : super(key: key);
    ...
    return Container(
        ...
        child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return ChatcomponentItemWidget(onTapChatComponent: () {
