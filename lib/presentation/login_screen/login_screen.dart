...
class LoginScreen extends StatelessWidget {
                                                  ...
                                                  child: Container(
                                                      ...
                                                      child: GestureDetector(
                                                          ...
                                                          child: Container(
                                                              ...
                                                              child: Text("Login", style: CustomTextStyles.headlineSmallRoundedMplus1cBoldGray70002))))),
  ...
  /// Navigates to the loginPageThreeScreen when the action is triggered.
  onTapFive(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.loginPageThreeScreen);
  }
}
